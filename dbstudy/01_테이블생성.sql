...
DESCRIBE SYS.USER_CONSTRAINTS;  -- SYS. 생략 가능
...
CREATE TABLE USER_TBL(
    ...
    USER_NAME VARCHAR2(30 BYTE) NULL,   -- NULL : NULL이여도 된다. (무조건 NULL이 아님)
    USER_AGE NUMBER(3) NULL CHECK(USER_AGE BETWEEN 0 AND 100), -- 0부터 100까지
