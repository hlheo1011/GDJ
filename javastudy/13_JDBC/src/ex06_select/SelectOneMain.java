...
public class SelectOneMain {
	...
	public static void main(String[] args) {
		...
		try {
			...
			con = DriverManager.getConnection(url, user, password); // 3번째꺼
			
			// 쿼리문 작성
			// SELECT문의 결과가 단일 행인 경우
			// 1. WHERE 절에서 PK 또는 UNIQUE 칼럼과 동등 비교(=)를 수행
			// 2. 집계 함수의 결과를 조회
			...
			// rs.next() 메소드는 스캔 성공 시 true, 스캔 실패시 false 반환
