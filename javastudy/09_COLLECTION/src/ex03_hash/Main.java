...
public class Main {
	...
	public static void main(String[] args) {		
		...
		System.out.println(book1.equals(book2)); 	// false. hash code를 비교한거다.
		*/
		...
		System.out.println(book4.hashCode());	// 동일함 ~ ~
		
		Set<Book> books = new HashSet<Book>();
		books.add(book1);
		books.add(book2);
		books.add(book3);
		books.add(book4);	// 중복 저장 시도(정상 동작하려면 Book 클래스에 hashCode(), equals() 메소드를 Override를 해야 함)
