...
public class Ex04_switch {
	...
	public static void main(String[] args) {
		...
		// case 값: 실행문; break;
		// case 값: 실행문; break;
		// case 값: 실행문; break; // break의 뜻은 'swith 실행문을 종료합니다' 라는 의미이다.
		// default: 실행문; // default는 통상 break를 쓰지 않는다.
		// }
		
		// swith가 가진 장점은 if와 비교했을때 보기 좋다.
		
		
		int step = 1;
		
		switch(step) {
		case 1: System.out.println("1단계"); break; // break가 없으면 case 1 ~ default 까지 출력된다.
		...
		String right = ""; // 권한
		switch(level) {
		case 1: right += "쓰기 "; // break를 만날때까지 실행됨
		case 2: right += "실행 ";
