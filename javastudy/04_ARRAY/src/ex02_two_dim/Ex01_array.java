...
public class Ex01_array {
	...
	public static void main(String[] args) {
		...
		// int[][] arr;
		// 2. 2차원배열의 생성
		// 	1) arr = new int[3][2];	- 의미 : 3행 2열의 구조 (김밥 3줄, 각 2개씩 조각)
		//  2) arr = new int[3][];  - 의미 : 3행 n열의 구조 (김밥 3줄, 모두 다르게 조각)
		...
		for(int i = 0; i < arr1.length; i++) {	// i : 몇 번째 1차원배열인가?
			for(int j = 0; j < arr1[i].length; j++) {	// j : 1차원배열의 몇번째 요소인가?
