...
@RequestMapping("member")	// URL Mapping이 member로 시작하는 모든 요청을 처리하는 컨트롤러 이다.
@Controller
public class Mycontroller1 {
	...
	// location.href='${contextPath}/member/detail2?id=admin&=1234';
	@GetMapping("detail2")
	...
	// <form action="${contextPath}/member/detail4" method="post">	// index.jsp의 method 방식을 post로 바꿔주고 실행하기
