...
public class SpringMain {
	...
	public static void main(String[] args) {
		...
		Student student = ctx.getBean("haksang", Student.class);	// Student student = (Student)ctx.getBean("haksang"); 같은 코드
		System.out.println(student.getName());
		System.out.println(student.getSchool());
		student.getCalculator().add(7, 3);	// student에 있는 calculator을 가져와서 add를 한다.
