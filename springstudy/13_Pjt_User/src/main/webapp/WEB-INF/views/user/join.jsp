...
<script>
	...
	function fn_idCheck(){
		$('#id').keyup(function(){
			...
			// 중복체크
			// script에서 DB가는법 = ajax 요청하고 마는게 아니라, 응답까지
			$.ajax({
				/* 요청 */
				type: 'get',
...
<body>
	...
	<div>
		...
		<form id="frm_join" action="${contextPath}/user/join" method="post">
			...
			<input type="hidden" name="promotion" value="${promotion}"> <!-- controller의 joinWrite에서 받아옴 -->
			
			<!-- 아이디 -->
			<div>
				<label for="id">아이디 <strong style="color: red;">*</strong></label>
			...
			<!-- 패스워드 -->
			<div>
				<label for="pw">패스워드 <strong style="color: red;">*</strong></label>
			...
			<!-- 패스워드 재확인 -->
			<div>
				<label for="re_pw">패스워드 <strong style="color: red;">*</strong></label>
				<input type="password" id="re_pw"><!-- 비번재확인은 name이 필요가 없다. 넘길 필요가 없기 때문에 -->
				<span id="msg_re_pw"></span>
			</div>
			
			<!-- 이름 -->
			<div>
				<label for="name">이름 <strong style="color: red;">*</strong></label>
				<input type="text" name="name" id="name">
				<!-- 이름은 검사를 안하기 때문에 span이 필요 없다. -->
			</div>
			...
			<!-- 휴대전화 -->
			<div>
				<label for="mobile">휴대전화 <strong style="color: red;">*</strong></label>
			...
			<!-- 생년월일 -->
			<div>
				<label for="birthyear">생년월일 <strong style="color: red;">*</strong></label>
			...
			<!-- 이메일 -->
			<div>
				<label for="email">이메일 <strong style="color: red;">*</strong></label>
