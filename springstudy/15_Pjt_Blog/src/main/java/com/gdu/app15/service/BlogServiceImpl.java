...
public class BlogServiceImpl implements BlogService {
	...
	@Override
	public void getBlogList(Model model) {	// 현재 request에는 page=수가 들어가 있다.
	...
	public void saveBlog(HttpServletRequest request, HttpServletResponse response) {
		...
		Optional<String> opt = Optional.ofNullable(request.getHeader("X-Forwarded-For"));	// Header가 null이 나올수 있어서 Optional을 썼다.
	...
	public Map<String, Object> saveSummernoteImage(MultipartHttpServletRequest multipartRequest) {
		...
		// 저장한 File 객체
		File file = new File(dir, filesystem);	// 앞에는 경로, 뒤에는 filesystem- 파일이름
